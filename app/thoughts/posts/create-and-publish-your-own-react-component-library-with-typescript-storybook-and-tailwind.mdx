...
package name to whatever we want, in our case it is called `@andreiescalante/playground`

```json
"name": "@andreiescalante/playground",
"author": "Andrei Escalante",
"version": "0.0.1",
```
...
Boom, you are done! you can now check our NPM account for our new package [@andreiescalante/playground](https://www.npmjs.com/package/@andreiescalante/playground).
